...
---
## Publications
* Peng, Tingting, Ho, Chun-Yu, Huang, Shaoqing, Zhang, Mingda. Supply-induced Litigation and the Role of Informal Institutions[J]. Economics of Transition and Institutional Change, 2026, 1-13.
...
This paper examines the economic impacts of large theme park openings in China from 2000 to 2023 using a newly compiled dataset on county-level theme parks and entrepreneurship. Leveraging the staggered openings of theme parks across various counties, we document three main findings. First, theme park openings lead to a 12.1% increase in entrepreneurial activities, especially in tourism-related service sectors. This result is robust to the heterogeneous treatment effect, alternative specification, excluding confounding policies, and placebo tests. Second, the spillover effects within a 25-to-50-kilometer radius are concentrated in tourism-related, consumption-based industries, and crowd-out effects within 25 kilometers are mainly in non-service sectors and real estate. Third, we identify tourism-driven consumption and agglomeration as the potential mechanisms driving these economic impacts. Back-of-the-envelope calculations suggest that theme park openings promote employment by 9.3%. This study sheds new light on the evaluation of the effectiveness of tourism-related place-based policies.
